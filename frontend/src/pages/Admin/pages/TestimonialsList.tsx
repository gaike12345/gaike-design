import { useState, useEffect } from 'react'; import { Link } from 'react-router-dom'; import { FaPlus, FaEdit, FaTrash, FaQuoteLeft, FaUser } from 'react-icons/fa'; import { api, deleteTestimonial } from '../api';
